...
class Configuration {
    ...
    get accessToken() {
        ...
        if (accessToken) {
            return typeof accessToken === 'function' ? accessToken : () => tslib_1.__awaiter(this, void 0, void 0, function* () { return accessToken; });
        }
        return undefined;
    }
    get headers() {
...
class BaseAPI {
    constructor(configuration = exports.DefaultConfig) {
        this.configuration = configuration;
        this.fetchApi = (url, init) => tslib_1.__awaiter(this, void 0, void 0, function* () {
    ...
    createFetchParams(context, initOverrides) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const initOverrideFn = typeof initOverrides === "function"
                ? initOverrides
                : () => tslib_1.__awaiter(this, void 0, void 0, function* () { return initOverrides; });
            const initParams = {
